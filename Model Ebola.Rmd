...
[The WHO statistics](http://apps.who.int/gho/data/view.ebola-sitrep.ebola-summary-20150731?lang=en)
...
high.para["k"] <- 0.38
high.para["f"] <- 0.71
high.para["Bo"] <- 2.1*10^-6

low.para <- st.para
low.para["k"] <- 0.1
low.para["f"] <- 0.14
low.para["Bo"] <- 0.7^10^-6
...
lines(st.out[,1], st.out[,2],
      type = "l",
      col = "black")
# lines(high.out[,1], high.out[,2],
#       col = "red",
#       type = "l",
#       lty = 1)
# lines(low.out[,1], low.out[,2],
#       col = "red",
#       type = "l",
#       lty = 1)
#     
