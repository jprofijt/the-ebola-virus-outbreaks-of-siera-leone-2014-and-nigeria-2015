...
```{r}
exp.para.df <- data.frame(st.para)
...
plot(ebola_data.sorted$time.points, ebola_data.sorted$Total.Cases..Sierra.Leone,
     ...
     sub = "Model transmission decay set to 0.011(was k=0.19) and time to implement controlmeasures set to 200 days")
...
```
Figure 11: Model compaired to other outbreaks
