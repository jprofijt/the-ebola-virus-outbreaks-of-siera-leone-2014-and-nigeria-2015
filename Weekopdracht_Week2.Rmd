...
__A).__ Bij de concentratie vrije receptoren daalt de concentratie exponenteel, dit komt namelijk omdat de concentratie mRNAa ook sterk daalt en tegelijkertijd worden de vrije receptoren nog wel gebruikt

__B).__ De concentratie MPL-receptoren stijgt hier in het begin enorm, dit is te verklaren omdat er in het begin nog genoeg mRNAR is om de reactie sneller te laten gaan echter op een gegeven moment wordt er een punt bereikt dat er niet meer genoeg mRNAR is waardoor er minder MPL-receptoren zullen worden gemaakt, de daling zal hier dan door gaan totdat het evenwicht is bereikt.

__C).__ Voor deze concentratie geldt ongeveer het zelfde als de concentratie MPL-receptoren, echter hier heeft de concentratie MPL-receptoren direct effect op de concentratie MPL-receptoren in de celkern, hierdoor is piek bij beide ongeveer op het zelfde tijdstip en zullen ze ook ongeveer op het zelfde tijdstip hun evenwicht bereiken, deze concentratie reageert alleen slomer omdat de receptor niet in de celkern wordt gemaakt

Op basis van deze resultaten zou ik zeggen dat ks_R hier het belangrijkste variable is, deze is namelijk verantwoorderlijk voor de omzetting van mRNAR en R, als deze reactie langzamer zou gaan of sneller zou gaan dan zou het hele model veranderen
