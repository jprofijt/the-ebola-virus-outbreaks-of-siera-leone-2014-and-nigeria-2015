...
lines(medians[,2][medians$dose == 0.3| medians$dose == 0.0], medians[,4][medians$dose == 0.3| medians$dose == 0.0],
      col = "red",
      type = "o",
      lty = 1,
      pch = 16)
...
lines(medians[,2][medians$dose == 0.1| medians$dose == 0.0], medians[,4][medians$dose == 0.1| medians$dose == 0.0],
      col = "red",
      type = "o",
      lty = 1,
      pch = 16)
...
__ [2]. __
als de dosis verlaagt dan is het evenwicht hoger, het dal wordt dan eerder bereikt, de reactie is dus minder sterk
